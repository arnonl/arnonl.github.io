...
### R fundamentals 04: Elements of programming and basic debugging skills  
...
<span style="color:blue">**Classwork/Homework**</span>: Repeat the previous classwork, this time adding an _else statement_ that prints "x is positive or zero", when needed.
...
**Note**: R comes out of the _if statement_ as soon as the condition is met. It will **not** evaluate further conditions down the line even if they satisfy.
...
* [An Introduction to R (pg. 40)](https://cran.r-project.org/doc/manuals/R-intro.pdf)
