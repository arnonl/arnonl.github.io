...
### R fundamentals 02: Advanced data types (Jul 12, 2019)
...
```{r eval=FALSE}
  factor(blood_type_factor, levels=c("A","B","AB","O"), labels=c("BT_A","BT_B","BT_AB","BT_O"))
```
...
```{r eval=TRUE}
  ...
  patient[[1]]
  class(patient[[1]])
  # Show the third element of the list
  patient[3]
  # Access the content of the third "element" - which is actually a list itself.
  patient[[3]]
```
