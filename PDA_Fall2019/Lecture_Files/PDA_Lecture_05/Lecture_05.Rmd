---
# title: "Lecture 05, Visualize and explore"
...
Solutions:
(1) Nothing (just creates the basis for the plot)
(2) `nrow(HANES)` ; `ncol(HANES)`
(3) DX_DBTS: whether participant was previously diagnosed with Diabetes or not
(4) `ggplot(data = HANES) + geom_point(mapping = aes(x = A1C, y = HDL))`
