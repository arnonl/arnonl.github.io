...
Remember, packages are extentions of R's basic features  
...
2. How many rows are in HANES? How many columns? Give three ways to see it.
...
For x and y aesthetics, ggplot2 does not create a legend, but it creates an axis line 
with tick marks and a label.  
...
In fact, we can overlay two geoms on the **same** plot - super cool, isn't it?  
(compare it with `abline()` function):
...
**Note**: One can use this idea for plotting different **data** to different layers. 
