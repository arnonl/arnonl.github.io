...
### R fundamentals 01: Elementary data types (Jul. 05, 2018)
...
We can paste rows or columns using the functions `cbind()` (for column binding) and `rbind() (for row binding) - really **important** - you will see them in lots of applications.
